...
class Whitelist(TimeStampedModel):
    ...
    site_account = models.ForeignKey(User, null=True, blank=True, related_name='whitelisting', on_delete=models.CASCADE)
...
class ProjectMembership(models.Model):
    project = models.ForeignKey(Project, null=True, related_name='member_list', on_delete=models.CASCADE)
    user = models.ForeignKey(Whitelist, related_name='member_projects', on_delete=models.CASCADE)
